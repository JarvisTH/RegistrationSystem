...
public class PatientController {
    ...
    public String listPatient(List<Patient> patients,Model model){
        if(patients==null){
    ...
    public String getPatientListByPara(int id, String name, String sex, RedirectAttributes ra){
        List<Patient> patients=patientService.getPatientList(id,name,sex);
        ra.addAttribute("patients",patients);
        return "redirect:admin/listPatient";
    }
}
